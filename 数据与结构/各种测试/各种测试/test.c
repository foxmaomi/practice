...
//输出叶子结点
void _InOrderstack(BinTreeNode *t)
{
	if (t != NULL)
	{
		_InOrderstack(t->leftChild);
		if (t->leftChild == NULL && t->rightChild == NULL)
			printf("%c ", t->data);  //输出叶子结点
		_InOrderstack(t->rightChild);
	}
}
void InOrderstack(BinTree *t)
{
	_InOrderstack(t->root);
}
//输出度为二的结点
/*void _InOrderdouble(BinTreeNode *t)
{
if(t!= NULL)
{
_InOrderdouble(t->leftChild);
if((t->leftChild!=NULL && t->rightChild==NULL) || (t->leftChild == NULL && t->rightChild != NULL))
printf("%c ",t->data);
_InOrderdouble(t->rightChild);
}
}*/
void _InOrderdouble(BinTreeNode *t)
{
...
void InOrderdouble(BinTree *t)
{
	_InOrderdouble(t->root);
}
int main()
{
