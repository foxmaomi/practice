...
//void BinTreeCreateBy_VLR_LVR(BinTree *t, char *vlr, char *lvr, int n)
//{
//	t->root = _BinTreeCreateBy_VLR_LVR(clr, lrv, n);
//}
//BinTreeNode* _BinTreeCreateBy_VLR_LV(char *lvr, char *lrv, int n)
//{
//
//}
//
...
////
////}
////void BinTreeCreateBy_LVR_LRV(BinTree *t, char *lvr, cahr *lrv, int n)
////{
////	t->root = _BinTreeCreateBy_LVR_LRV(lvr, lrv, n);
////}
//void BinTreeInit(BinTree *t)
